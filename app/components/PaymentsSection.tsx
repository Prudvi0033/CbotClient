        ...
        >
          ...
          <div
            className="w-12 h-12 flex items-center justify-center 
                          bg-neutral-400/70 border-2 shadow-[inset_8px_8px_12px_rgba(255,255,255,0.5),4px_2px_6px_rgba(0,0,0,0.1)] border-neutral-200 rounded-lg shrink-0"
          >
            <svg
              width="30px"
              height="30px"
            ...
            >
              <g fill="none" className="nc-icon-wrapper">
                ...
                <defs>
                  ...
                  <linearGradient
                    id="ouxv6bmmkj-1752500502812-6140456_wallet-content_existing_1_7cu7qxlwm"
                    x1="22"
                    y1="13.5"
                    x2="2"
                    y2="13.5"
                  ...
                  <linearGradient
                    id="ouxv6bmmkj-1752500502812-6140456_wallet-content_existing_2_62o0vvap5"
                    x1="12"
                    y1="5"
                    x2="12"
                    y2="14.845"
                  ...
                  <linearGradient
                    id="ouxv6bmmkj-1752500502812-6140456_wallet-content_existing_3_pdgfrbs9f"
                    x1="19"
                    y1="10"
                    x2="19"
                    y2="17"
                  ...
                  <filter
                    id="ouxv6bmmkj-1752500502812-6140456_wallet-content_filter_69p3uk0u4"
                    x="-100%"
                    y="-100%"
                    width="400%"
                    height="400%"
                  ...
                  <clipPath id="ouxv6bmmkj-1752500502812-6140456_wallet-content_clipPath_h7u17fg1w">
                    <path
                      d="M15.6 5C17.8402 5 18.9603 5 19.816 5.43597C20.5686 5.81947 21.1805 6.43139 21.564 7.18404C22 8.03969 22 9.15979 22 11.4L22 15.6C22 17.8402 22 18.9603 21.564 19.816C21.1805 20.5686 20.5686 21.1805 19.816 21.564C18.9603 22 17.8402 22 15.6 22L8.4 22C6.15979 22 5.03968 22 4.18404 21.564C3.43139 21.1805 2.81947 20.5686 2.43597 19.816C2 18.9603 2 17.8402 2 15.6L2 11.4C2 9.15979 2 8.03968 2.43597 7.18404C2.81947 6.43139 3.43139 5.81947 4.18404 5.43597C5.03968 5 6.15979 5 8.4 5L15.6 5Z"
                      fill="url(#ouxv6bmmkj-1752500502812-6140456_wallet-content_existing_1_7cu7qxlwm)"
                    ></path>
                  </clipPath>
                  <mask id="ouxv6bmmkj-1752500502812-6140456_wallet-content_mask_qkctbcwzb">
