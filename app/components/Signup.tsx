      ...
      <div className="overflow-hidden w-full max-w-lg">
          ...
          <div className="p-2">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">Explore the latest deals, track payments, and manage orders.</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={signup.phone}
                  onChange={(e) => setSignup(prev => ({...prev, phone: e.target.value}))}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Address <span className="text-gray-500">(optional)</span></label>
                <input
                  type="text"
                  name="address"
                  value={signup.address}
                  onChange={(e) => setSignup(prev => ({...prev, address: e.target.value}))}
